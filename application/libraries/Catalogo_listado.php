...
class Catalogo_listado {
	...
	*/
	private $catalogos = array(self::ALINEACIONES_ESTRATEGICAS => array('table'=>self::ALINEACIONES_ESTRATEGICAS, 'llave'=>'id_alineacion_estrategica', 'valor'=>'descripcion', 'orden'=>'descripcion'),
		...
		self::GRUPOS_CATEGORIAS => array('table'=>self::GRUPOS_CATEGORIAS, 'llave'=>'id_grupo_categoria', 'valor'=>'nombre', 'orden'=>'nombre'),
		...
		self::SUBCATEGORIAS => array('table'=>self::SUBCATEGORIAS, 'llave'=>'id_subcategoria', 'valor'=>'nombre', 'orden'=>'nombre'),
