...
<script type="text/javascript">
  function chart(id_chart, tabla,titulo){
   ...
   $(document).ready(function(){
    //chart
      chart("chrt_inscritos", "table_inscritos","");
      chart("chrt_aprobados", "table_aprobados","");
      chart("chrt_suspendidos", "table_suspendidos","");
      chart("chrt_etm", "table_etm","");
    });
</script>
