            ...
            <?php foreach ($valores as $llave => $valor) {
                if(isset($valor['cantidad_alumnos_inscritos'])){
                    echo '<tr>
                        ...
                        <td><div id="total_alumnos_aprobados" class="text-center">'.$valor['cantidad_no_accesos'].'</div></td>
                    ...
                    foreach ($valor as $key_sub => $subvalor) {
                        echo '<tr>
                            ...
                            <td><div id="total_alumnos_aprobados" class="text-center">'.$subvalor['cantidad_no_accesos'].'</div></td>
